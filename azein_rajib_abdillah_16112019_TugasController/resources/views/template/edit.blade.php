...
<body>
					  ...
					  <div class="container-fluid nav-bar">
					    ...
					    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					      ...
					      <ul class="nav navbar-nav navbar-right">
					        ...
					        <li><a class="menu active" href="profile"> Profile</a></li>
					      </ul>
					    </div><!-- /navbar-collapse -->
					  </div><!-- / .container-fluid -->
					</nav>
	...
	<div class="well">
		<h3 style="color:#000;">Edit User</h3>

		<form class="form">
			<input class="name" type="text" placeholder="Username" value="azein">
			<input class="email" type="email" placeholder="Email" value="azeinrajibadbillah@gmail.com">
			<input class="email" type="password" placeholder="Password">
			<a class="btn btn-primary" href="profile">Update</a>
		</form>
